      ...
      <div style={{ flex:1, overflowY:"auto", background:"#F2F4F8", borderRadius:"24px 24px 0 0", marginTop:-24, padding:"18px 14px 10px", WebkitOverflowScrolling:"touch" as any, overscrollBehavior:"contain" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:16 }}>
          {[
            ...
            ...(!isAdmin ? [{
              ...
              icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#DC2626" strokeWidth="2.2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>,
            ...
            <div
              key={i}
              onClick={k.onClick}
              style={{ background:"#fff", border:"1px solid #EEF0F3", borderRadius:12, padding:"11px 10px", display:"flex", alignItems:"center", gap:9, boxShadow:"0 1px 3px rgba(0,0,0,0.04)", cursor: k.onClick ? "pointer" : "default" }}
            >
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:6, marginBottom:8 }}>
          {[
            ...
            { bg:"#DCFCE7", label:"Mis pantallas", tab:"mispantallas" as const,
              icon:<svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2" strokeLinecap="round"><rect x="2" y="4" width="20" height="13" rx="2"/><path d="M8 21h8M12 17v4"/></svg> },
            ...
            { bg:"#FEE2E2", label:"Facturas", tab:"facturas" as const,
              icon:<svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="#DC2626" strokeWidth="2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> },
          ].map(q => (
        ...
        {!isAdmin && (
          <div
            onClick={() => onGoTo("nueva")}
            style={{
              display:"flex", alignItems:"center", justifyContent:"center", gap:8,
              background:"#fff", border:"1px dashed #D1D5DB", borderRadius:12, padding:"10px",
              marginBottom:16, cursor:"pointer", fontSize:13, fontWeight:600, color:"#374151",
            }}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#EA580C" strokeWidth="2.2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
          ...
          {ultima ? (
            <div style={{ display:"flex", gap:11, alignItems:"flex-start" }}>
              ...
              <div style={{ flex:1, paddingTop:2 }}>
                ...
                <div onClick={() => onGoTo("reportes")} style={{ display:"inline-flex", alignItems:"center", gap:2, color:"#2563EB", fontSize:13, fontWeight:600, cursor:"pointer" }}>
                  Ver reportes <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round"><polyline points="9 18 15 12 9 6"/></svg>
                </div>
              </div>
            </div>
          ) : (
