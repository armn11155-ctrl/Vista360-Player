    ...
    <div className="inicio-screen" style={{ display:"flex", flexDirection:"column", height:"100%", background: HEADER }}>
      ...
      <div className="inicio-header" style={{ padding:"calc(14px + env(safe-area-inset-top)) 22px 42px", flexShrink:0, background:headerBg }}>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", position:"relative", marginBottom:30 }}>
          ...
          <img src="/logo-player.png" decoding="async" alt="Vista360 Player" className="inicio-logo" style={{ height:36, maxWidth:"64%", objectFit:"contain", position:"relative", top:9 }} />
