...
describe("refinamiento premium aprobado", () => {
  it("integra marca y acceso en una sola arquitectura de login", () => {
    ...
    expect(login).toContain("login-led-scene-results");
    expect(login).toContain("login-led-scene-closing");
    expect(login).toContain("Tu campaña,");
    expect(login).toContain("Control en");
    expect(login).toContain("Listos para");
    ...
    expect(estilos).toContain("login-report-bar-four");
    expect(estilos).toContain("login-report-check-arrive");
    expect(estilos).toContain("login-control-progress-head");
    expect(estilos).toContain("login-report-sheet-period");
    expect(login).not.toContain("login-led-eyebrow-closing");
